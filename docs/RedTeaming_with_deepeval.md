# A Tutorial on Red-Teaming Your LLM (/guides/guides-red-teaming)
...
## 1. Setting up your Target LLM [#1-setting-up-your-target-llm]
...
### Testing your Target LLM [#testing-your-target-llm]
...
## 2. Initializing the RedTeamer [#2-initializing-the-redteamer]
...
### Target LLM Parameters [#target-llm-parameters]
...
## 3. Scan your Target LLM [#3-scan-your-target-llm]
...
### Tips for Effective Red-Teaming Scans [#tips-for-effective-red-teaming-scans]
...
### Considerations for Attack Enhancements [#considerations-for-attack-enhancements]
...
## 4. Interpreting Scanning Results [#4-interpreting-scanning-results]
...
### Detailed Vulnerability Breakdown [#detailed-vulnerability-breakdown]
...
## 5. Iterating on Your Target LLM [#5-iterating-on-your-target-llm]
